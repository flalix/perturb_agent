...
<RootWidget>:
    ...
    BoxLayout:
        ...
        Spinner:
            id: sp_primary_site
            text: root.primary_site_selected
...
class RootWidget(BoxLayout):
    ...
    def load_programs(self) -> None:
        try:
            ...
            # below the program dropdown, all initially empty
            self.primary_site_values = []
            self.primary_site_selected = ""
            self.ids.sp_primary_site.text = ""

            # auto-load sites for default program
    ...
    def fetch_cases(self) -> None:
        try:
            ...
            self.df_cases2 = df_cases[case_cols_src].copy()
