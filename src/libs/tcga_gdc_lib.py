...
class GDC(object):
    def __init__(self, ROOT_DATA0: Path, ROOT_SRC: Path):
        ...
        self.SUBTYPE_GENES2 = {
            "TCGA-BRCA": {
                "Luminal_A": {"PIK3CA", "GATA3", "MAP3K1", "CDH1", "TBX3", "RUNX1", "FOXA1"},
                "Luminal_B": {"PIK3CA", "TP53", "GATA3", "RB1", "CCND1", "ERBB2"},
                "HER2": {"ERBB2", "PIK3CA", "TP53", "PTEN"},
                "TNBC_Basal": {"TP53", "BRCA1", "RB1", "PTEN", "NF1"},
